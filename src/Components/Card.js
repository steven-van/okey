    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:scale-105 transition duration-500">
      ...
      <div class="p-5">
        <div class="flex justify-between items-center">
          ...
          <p class="text-md font-semibold tracking-tight text-gray-900 dark:text-gray-400">
            50 m², 2 rooms, Paris
          </p>
        </div>
        ...
        <div class="flex items-center mt-2.5 mb-5">
          ...
          <span class="bg-red-200 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-800 ml-3">
            5.0
          </span>
        </div>
